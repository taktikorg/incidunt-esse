<div align="center">
  <a href="https://github.com/taktikorg/incidunt-esse">
    <img width="180" height="180" src="logo.svg" alt="Logo">
  </a>
  <br>
  <br>
  <img alt="CI/CD" src="https://github.com/taktikorg/incidunt-esse/workflows/CI/CD/badge.svg">
  <a href="https://badge.fury.io/js/@taktikorg/incidunt-esse">
    <img alt="npm version" src="https://badge.fury.io/js/@taktikorg/incidunt-esse.svg">
  </a>
  <a href="https://codecov.io/gh/lynxtaa/@taktikorg/incidunt-esse" alt="npm version">
    <img alt="Codecov" src="https://img.shields.io/codecov/c/github/lynxtaa/@taktikorg/incidunt-esse">
  </a>
  <br>
  <br>
...
- Perfect for React apps in combination with [react-query](https://www.npmjs.com/package/react-query). See [Next.js example](https://github.com/taktikorg/incidunt-esse/tree/master/examples/next-js)

## Install

```sh
npm install @taktikorg/incidunt-esse
```
...
```js
import { AwesomeGraphQLClient } from '@taktikorg/incidunt-esse'
...
const { AwesomeGraphQLClient } = require('@taktikorg/incidunt-esse')
...
Check out full example at [examples/typed-document-node](https://github.com/taktikorg/incidunt-esse/tree/master/examples/typed-document-node)

## Error Logging

```js
import { AwesomeGraphQLClient, GraphQLRequestError } from '@taktikorg/incidunt-esse'
...
```js
import { AwesomeGraphQLClient, gql } from '@taktikorg/incidunt-esse'
...
```js
const { AwesomeGraphQLClient, isFileUpload } = require('@taktikorg/incidunt-esse')
...
[https://github.com/taktikorg/incidunt-esse/tree/master/examples](https://github.com/taktikorg/incidunt-esse/tree/master/examples)
